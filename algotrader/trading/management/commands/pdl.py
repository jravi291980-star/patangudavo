...
from trading.websockets import cache_previous_day_hl
import logging
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Successfully cached previosu day high snd low of  all instruments.'))
