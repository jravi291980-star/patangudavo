...
# --- CACHING (FIXED FOR UTHO/LOCAL REDIS) ---
...
CACHES = {
    "default": {
        ...
        "OPTIONS": {
            ...
            # Empty options by default for local Redis
            "CONNECTION_POOL_KWARGS": {} 
        }
    }
}

# Only add SSL options if the URL actually starts with rediss://
...
STOCK_INDEX_MAPPING = {
    ...
    'POLYCAB': 'NIFTY 500',
    'EICHERMOT': 'NIFTY 500',
    'APOLLOHOSP': 'NIFTY 500',
    'CRAFTSMAN': 'NIFTY 500',
    'NSIL': 'NIFTY 500',
    'AMBER': 'NIFTY 500',
    'DIVISLAB': 'NIFTY 500',
    'PERSISTENT': 'NIFTY 500',
    'LTIM': 'NIFTY 500',
    'ESABINDIA': 'NIFTY 500',
    'NAVINFLUOR': 'NIFTY 500',
    'ICRA': 'NIFTY 500',
    'LINDEINDIA': 'NIFTY 500',
    'HEROMOTOCO': 'NIFTY 500',
    'ATUL': 'NIFTY 500',
    'BRITANNIA': 'NIFTY 500',
    ...
    'KINGFA': 'NIFTY 500',
    'DMART': 'NIFTY 500',
    'MUTHOOTFIN': 'NIFTY 500',
    'SCHAEFFLER': 'NIFTY 500',
    'TORNTPHARM': 'NIFTY 500',
    'SMLMAH': 'NIFTY 500',
    'AIAENG': 'NIFTY 500',
    'CEATLTD': 'NIFTY 500',
    'SWARAJENG': 'NIFTY 500',
    ...
    'LUPIN': 'NIFTY 500',
    'E2E': 'NIFTY 500',
    'BHARTIARTL': 'NIFTY 500',
    'BAJAJFINSV': 'NIFTY 500',
    ...
    'RACLGEAR': 'NIFTY 500',
    'KIRLPNU': 'NIFTY 500',
    'ADANIGREEN': 'NIFTY 500',
    'IMPAL': 'NIFTY 500',
    'EIDPARRY': 'NIFTY 500',
    'DREDGECORP': 'NIFTY 500',
    'INTELLECT': 'NIFTY 500',
    'JINDALSTEL': 'NIFTY 500',
    'SEAMECLTD': 'NIFTY 500',
    'KERNEX': 'NIFTY 500',
    'GRINFRA': 'NIFTY 500',
    'CCL': 'NIFTY 500',
    'EXPLEOSOL': 'NIFTY 500',
    'HATSUN': 'NIFTY 500',
    'BAJFINANCE': 'NIFTY 500',
    'GODREJIND': 'NIFTY 500',
    'MACPOWER': 'NIFTY 500',
    'LAURUSLABS': 'NIFTY 500',
    'ADANIENSOL': 'NIFTY 500',
    'WEALTH': 'NIFTY 500',
    'HDFCBANK': 'NIFTY 500',
    'GROBTEA': 'NIFTY 500',
    'GMBREW': 'NIFTY 500',
    ...
    'YUKEN': 'NIFTY 500',
    'GOKEX': 'NIFTY 500',
    'SHRIRAMFIN': 'NIFTY 500',
    'ELECTHERM': 'NIFTY 500',
    'INDUSINDBK': 'NIFTY 500',
...
# NOTE: FNO and Other massive lists are truncated here for brevity in the chat output.
# Please Ensure you keep your full SIMULATION_FNO_STOCKS, STOCK_INDEX_MAPPING, 
# and SHARIA_COMPLIANT_STOCKS lists when you paste this file.
# 
# ... [INSERT YOUR FULL STOCK LISTS HERE] ...
# 
# For the purpose of this file block, I will include the INDEX_SYMBOLS as it is short.
...
# --- ALGO TRADING REDIS CONFIGURATION (NEW) ---
# These keys align with the refactored websocket.py and *_engine.py files

# Core Data Channels
LIVE_OHLC_KEY = "live_ohlc_data"        # Snapshot of all stocks (updated every ~1s)
PREV_DAY_HASH = "prev_day_ohlc"         # Previous Day High/Low/Close
TICK_STREAM_KEY = "tick_stream"         # High-Frequency Real-time Ticks (Stream)
CANDLE_STREAM_KEY = "candle_1m"         # 1-Minute Candle Data (Stream)

# Engine Specific Mappings (Points to Core Keys)
# This ensures all engines listen to the same unified stream
BREAKOUT_CANDLE_STREAM = CANDLE_STREAM_KEY
BREAKDOWN_CANDLE_STREAM = CANDLE_STREAM_KEY
MOM_BULL_CANDLE_STREAM = CANDLE_STREAM_KEY
MOM_BEAR_CANDLE_STREAM = CANDLE_STREAM_KEY

BREAKOUT_LIVE_OHLC_KEY = LIVE_OHLC_KEY
BREAKDOWN_LIVE_OHLC_KEY = LIVE_OHLC_KEY

BREAKOUT_PREV_DAY_HASH = PREV_DAY_HASH
BREAKDOWN_PREV_DAY_HASH = PREV_DAY_HASH
...
LOGGING = {
    ...
    'loggers': {
        ...
        'trading': {  # Captures logs from your engines
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': True,
        },
        'websocket': { # Captures websocket logs
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': True,
        }
